...
export function CodeEditor({
  ...
  useEffect(() => {
    ...
    const cspNonce = document.querySelector<HTMLMetaElement>('meta[property="csp-nonce"]')?.nonce;
    const view = new EditorView({
      ...
      state: EditorState.create({
        ...
        extensions: [
          ...
          EditorView.theme(
            {
              "&": { height: "100%", minHeight: "0", backgroundColor: "#121713", color: "#e8ecdf" },
              ".cm-scroller": { minHeight: "0", overflow: "auto", fontFamily: "monospace" },
              ".cm-gutters": { backgroundColor: "#171e18", color: "#98a692", border: "none" },
              ".cm-content": { caretColor: "#c8f169" },
              ".cm-activeLine": { backgroundColor: "#253022" },
            },
            { dark: true },
          ),
